...
안녕하세요😊
저는 품질 중심의 시각과 문제 해결 능력을 갖춘 소프트웨어 엔지니어입니다.
...
그리고 항상 더 나은 방법을 탐구하고 새로운 접근법을 탐색합니다.
...
- AI 자연어 처리(NLU) 학습 데이터 검수 및 한국어(Ko) 지역화 담당
- 이슈 패턴 기반 테스트 케이스 개선 및 QA 문서화 → 테스트 커버리지 향상
- AI 학습 + NLP 분석 복합 역할 수행
